...
public class ItemHandler {
    ...
    public static void initItemRegister(){
        ...
        ItemIDs.disc_redsun.item = new BaseItemRecordClass(ItemIDs.disc_redsun, JCRec.jcrecCreativeTracks);
        ...
        ItemIDs.disc_shakedanger.item = new BaseItemRecordClass(ItemIDs.disc_shakedanger, JCRec.jcrecCreativeTracks);
