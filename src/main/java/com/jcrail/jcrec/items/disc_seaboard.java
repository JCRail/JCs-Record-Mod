...
public class disc_seaboard extends ItemRecord {
    public disc_seaboard(String par0Str) {
        super(par0Str);
        setMaxStackSize(1);
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = iconRegister.registerIcon(JCRec.MODID.toLowerCase() + ":disc_seaboard");
    }
